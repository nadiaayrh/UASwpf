...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
			...
			<?php
              ...
              $AmbilDataManager = $daftar->AmbilDataManager();
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Icon Cards-->
	  <h4><i class="fa fa-american-sign-language-interpreting" aria-hidden="true"></i>Profil Anda</h4><br>
      <div class="card mb-3">
		...
		<br>
		<br>
	  <h4><i class="fa fa-american-sign-language-interpreting" aria-hidden="true"></i> Antrian</h4><br>
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5"> Antrian Sekarang</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="antriancek.php">
              <span a href="antriancek.php" class="float-left">Cek Data Antrian</span>
	  ...
	  <br><br>
	  <h4><i class="fa fa-american-sign-language-interpreting" aria-hidden="true"></i>  Laporan</h4><br>
	  <div class="row">
	  <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Laporan Pasien</div>
              <div class="mr-5"></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="laporan.php">
              <span class="float-left">Cek Data</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
		...
		<div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Laporan Kunjungan</div>
              <div class="mr-5"></div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="laporanwaktu.php">
              <span class="float-left">Cek Data</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
