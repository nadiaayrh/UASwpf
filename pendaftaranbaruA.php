...
<div class="container">
    ...
    <div class="row">
    	<div class="span8">        
        	<form id="pinjam-form" class="pinjam-form" method="post" action="pendaftaranbaruA.php">
				<p>	  
						<input id="kodepasien" name="kodepasien" type="kodepasien"  placeholder="NIK">
				</p>
				<p>	  
						<input id="nama" name="nama" type="text" placeholder="Nama Pasien">
				</p>
				<p>		
						<select id="jk" name="jk" placeholder="Jenis Kelamin">
				...
				<p>	  
						<input id="usia" name="usia" type="text" placeholder="Usia">
				</p>
				<p>	 
						<input id="keluhan" name="keluhan" type="text" placeholder="Keluhan">
				</p>
            	
                <p>
						<center><input type="submit" id="submit" class="submit" value="Cek Data"/></center>
				</p>
		...
		<div class="span4">
			...
			<table>
              <thead>
				<tr align="left">
					<th>Antrian</th><th>&nbsp;: &nbsp;</th><th>ANT-<?php echo $idantrian ?></th>
				</tr>
				<tr align="left">
			...
			<form id="pinjam-form" class="pinjam-form" method="post" action="prosesA.php">
